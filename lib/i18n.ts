...
export const messages = {
  es: {
    ...
    headerMenu: "Abrir menu de categorias",
    headerMenuClose: "Cerrar menu de categorias",
    headerMenuTitle: "Edicion movil",
    headerMenuHint: "Explora las categorias principales de Veloura sin salir del header.",
  ...
  en: {
    ...
    headerNavBodysuits: "Bodysuits",
    headerNavLounge: "Lounge",
    headerMenu: "Open category menu",
    headerMenuClose: "Close category menu",
    headerMenuTitle: "Mobile edit",
    headerMenuHint: "Browse the core Veloura categories directly from the header.",
