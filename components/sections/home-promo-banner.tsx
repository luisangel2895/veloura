...
export function HomePromoBanner({ label, copy }: HomePromoBannerProps) {
  return (
    <section className="rounded-[2rem] border border-border bg-card/70 px-5 py-5 shadow-sm dark:border-amber-500/10 dark:bg-card/60 sm:px-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <Button
          ...
          className="h-11 rounded-full border-border bg-transparent px-5 hover:bg-accent dark:border-amber-500/20 dark:hover:bg-amber-500/10"
        >
          Shop now
